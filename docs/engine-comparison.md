...
## 8. v0.5.1 POC 結果（方式 B）

v0.5.1 で方式 B（Markdig + Open XML SDK）の POC 実装を行い、実用可能であることを確認した。
...
方式 B への本実装移行を **v0.5.2** 以降の課題として提案する。
...
- 関連ドキュメント:
  ...
  - `docs/poc-openxml.md` — 方式 B の POC 記録（v0.5.1）

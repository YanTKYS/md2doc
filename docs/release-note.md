...
title: 配布前検証・受入テスト・運用整備フェーズ（予定）

v0.5.6 のドキュメント整理・v0.5.5 の品質整備を受けて、Open XML 方式を前提とした
配布前検証フェーズとして進める。

### 想定対応内容（未実装）

- `docs/test_scenarios.md` の実機確認項目を順次実施・結果記録
- 未確認項目（OX-14〜16、WD-01〜07、CFG-01〜04 等）の実機検証
- 配布パッケージの整備・インストール手順の確認
- Word COM 方式との最終比較確認（CMP-01〜03）
